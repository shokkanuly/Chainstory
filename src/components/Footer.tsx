...
const FOOTER_LINKS = {
  Services: ['Web Development', 'UI/UX Design', 'Mobile Apps', 'Digital Marketing', 'SEO'],
        ...
        <div className="footer__top">
          ...
          <div className="footer__brand">
            <a href="#" className="footer__logo">
              Studio<span className="footer__logo-dot">.</span>
            </a>
            <p className="footer__tagline">
              Crafting premium digital experiences for ambitious brands since 2021.
            </p>
